  ...
  inputSchema: {
    ...
    properties: {
      projectRoot: {
        type: "string",
        description:
          "Absolute path to the git root. Defaults to current git toplevel.",
      },
    },
  },
};
...
export async function handler(args: { projectRoot?: string }) {
  try {
