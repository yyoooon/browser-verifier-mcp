...
export const definition = {
    ...
    description: "Read OBSERVED computed style / text / classList / rect / attributes for one or more selectors in ONE batched page.evaluate. Use when expected values are UNKNOWN — e.g. first-pass Figma comparison, exploring current state before writing assertions, capturing computed token values (oklch, normalized rgb) to bake into a later verify check. " +
    ...
    inputSchema: {
        ...
        properties: {
            targets: {
                type: "object",
                description: "Dict of named inspection targets. Keys are user-chosen labels that appear in the output unchanged.",
                additionalProperties: {
                    ...
                    properties: {
                        ...
                        style: {
                            type: "array",
                            items: { type: "string" },
                            description: "Computed-style property names (camelCase or kebab-case).",
                        },
                        text: { type: "boolean" },
                        ...
                        rect: {
                            ...
                            description: "true → {x,y,width,height}. Array → subset (e.g. ['width','height']).",
                        },
